...
public class CourseController {
    ...
    public boolean getTime(@RequestParam(value = "userName") String userName){
        ...
        if(0!=n){
            ...
            try{
                ...
                if(c<24000*60*60){
                    ...
                    flag = false;
                    timeService.update(dateString,userName);
                }
